...
export class DeviceTypeView extends Component<IProps, {}> {
	render() {
		...
		return (
			...
			>
				...
				<Divider dashed />
				<div className="">
					<h6 className="text-muted text-uppercase mb-3">Device type details</h6>
					<p>
						<DatabaseOutlined />
					...
					<p>
						<CalendarOutlined />
						<StyledSpan className="text-dark">Protocol : {data?.protocol}</StyledSpan>
					</p>
				</div>
				<div className="mt-5">
